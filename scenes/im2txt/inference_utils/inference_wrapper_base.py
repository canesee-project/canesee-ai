...
class InferenceWrapperBase(object):
  ...
  def _create_restore_fn(self, checkpoint_path, saver):
    ...
    if tf.gfile.IsDirectory(checkpoint_path):
      ...
      #HERE
      checkpoint_path = "C:\save_model\models-master\im2txt\im2txt\chkpoint_temp\model.ckpt-2000000"
    ...
    def _restore_fn(sess):
      ...
      tf.compat.v1.logging.info("Loading model from checkpoint: %s","C:\save_model\models-master\im2txt\im2txt\chkpoint_temp\model.ckpt-2000000" )
     # saver.restore(sess, checkpoint_path)
      saver.restore(sess, "C:\save_model\models-master\im2txt\im2txt\chkpoint_temp\model.ckpt-2000000")
  ...
  def build_graph_from_proto(self, graph_def_file, saver_def_file,
    ...
    return self._create_restore_fn("C:\save_model\models-master\im2txt\im2txt\chkpoint_temp\model.ckpt-2000000", saver)
