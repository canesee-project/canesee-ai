...
class image_captioning ():
    ...
    def generate_from_saving_img(self,image):
        image_path = "temp.jpg"
...
if __name__ == '__main__':    
    ...
    while(1):
        ...
        im = cv2.imread(test_image)
        # print(model.generate_from_img_nparray(im))
        print(model.generate_from_saving_img(im))
        print(model.generate_from_img_path(test_image))
        print('\n')